...
Designed for wordpress hosting companies or wordpress site administrators, this plugin allows any user to send a support request by email directly from their dashboard.
The dashboard widget title, message, email recipient and email subject can all be specified in the plugin settings page.  
Please note: if the dashboard widget title is not set, it will NOT display, and obviously if no email address is set, an email will not be sent.
